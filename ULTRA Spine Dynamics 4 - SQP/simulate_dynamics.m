...
if (noise)
    for k = 1:links
        systemStates(k, 1) = combinedState(12*(k-1)+1) + 0.0005*randn(1); % x
        systemStates(k, 2) = combinedState(12*(k-1)+2) + 0.0005*randn(1); % y
        systemStates(k, 3) = combinedState(12*(k-1)+3) + 0.0005*randn(1); % z
        systemStates(k, 4) = combinedState(12*(k-1)+4) + 0.0005*randn(1); % T
        systemStates(k, 5) = combinedState(12*(k-1)+5) + 0.0005*randn(1); % G
        systemStates(k, 6) = combinedState(12*(k-1)+6) + 0.0005*randn(1); % P
        systemStates(k, 7) = combinedState(12*(k-1)+7) + 0.0001*randn(1); % dx
        systemStates(k, 8) = combinedState(12*(k-1)+8) + 0.0001*randn(1); % dy
        systemStates(k, 9) = combinedState(12*(k-1)+9) + 0.0001*randn(1); % dz
        systemStates(k, 10) = combinedState(12*(k-1)+10) + 0.0001*randn(1); % dT
        systemStates(k, 11) = combinedState(12*(k-1)+11) + 0.0001*randn(1); % dG
        systemStates(k, 12) = combinedState(12*(k-1)+12) + 0.0001*randn(1); % dP
    end
else
    for k = 1:links
