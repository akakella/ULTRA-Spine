function [ Te ] = getTensions(x2,y2,z2,T2,G2,P2,dx2,dy2,dz2,dT2,dG2,dP2,x3,y3,z3,T3,G3,P3,dx3,dy3,dz3,dT3,dG3,dP3, ...
    inp1,inp2,inp3,inp4,inp5,inp6,inp7,inp8,rest1,rest2,rest3,rest4,rest5,rest6,rest7,rest8,link)
...
L = lengths(x2,y2,z2,T2,G2,P2,x3,y3,z3,T3,G3,P3);
dlengths = dlengths_dt(x2,y2,z2,T2,G2,P2,dx2,dy2,dz2,dT2,dG2,dP2,x3,y3,z3,T3,G3,P3,dx3,dy3,dz3,dT3,dG3,dP3);
L = L(:, link);
