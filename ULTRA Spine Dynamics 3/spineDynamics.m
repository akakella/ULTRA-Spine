...
Dyn_eqn = [D2x(2); D2y(2); D2z(2); D2T(2); D2G(2); D2P(2); D2x(3); D2y(3); D2z(3); D2T(3); D2G(3); D2P(3)];
...
matlabFunction(lengths,'file','lengths','Vars',[x(2); y(2); z(2); T(2); G(2); P(2); x(3); y(3); z(3); T(3); G(3); P(3)]);
